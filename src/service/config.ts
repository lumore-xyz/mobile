...
const resolveAdMobConfig = <
  T extends {
    ...
    ADMOB_ANDROID_PROFILE_NATIVE_UNIT_ID: string;
    ADMOB_IOS_PROFILE_NATIVE_UNIT_ID: string;
...
>(
  ...
  ADMOB_PROFILE_NATIVE_UNIT_ID:
    Platform.OS === "ios"
      ? baseConfig.ADMOB_IOS_PROFILE_NATIVE_UNIT_ID
      : baseConfig.ADMOB_ANDROID_PROFILE_NATIVE_UNIT_ID,
});
...
const developmentConfig = resolveAdMobConfig({
  ...
  ADMOB_ANDROID_PROFILE_NATIVE_UNIT_ID:
    "ca-app-pub-5845343690682759/4011200682",
  ...
  ADMOB_IOS_PROFILE_NATIVE_UNIT_ID: "",
